...
class Encoder(nn.Module):
    def __init__(self, input_shape=[128,129,1], filters=[32, 64, 128], leaky=True, neg_slope=0.01, activations=False, bias=True):
...
class Decoder(nn.Module):
    def __init__(self, input_shape=[128,128,3], filters=[32, 64, 128], leaky=True, neg_slope=0.01, activations=False, bias=True):
